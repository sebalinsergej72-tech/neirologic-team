...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Telegram-бот — от 1 недели. Лендинг — от 2 недель. Веб-приложение — от 4 недель. Сложный SaaS — от 2 месяцев. Точные сроки зависят от объёма задач и фиксируются в договоре.",
  },
  {
