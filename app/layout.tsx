...
export const metadata: Metadata = {
  ...
  description:
    "Разработка сайтов, веб-приложений, Telegram-ботов, Mini Apps, автоматизация бизнеса и внедрение ИИ. Команда разработчиков. От заявки до запуска — от 3 дней. Бесплатная консультация.",
  keywords: [
    "разработка сайтов",
